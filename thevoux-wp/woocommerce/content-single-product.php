...
<div id="product-<?php the_ID(); ?>" <?php post_class('post product-page'); ?>>
	<div class="row">
			<div class="small-12 small-order-1 large-<?php echo esc_attr($product_image_size); ?> <?php echo esc_attr($product_image_position_class); ?> columns product-gallery carousel-container">
