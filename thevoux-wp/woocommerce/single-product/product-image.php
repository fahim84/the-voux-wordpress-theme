...
?>
<div id="product-images" class="<?php echo implode(' ', $classes); ?>" data-navigation="true" data-autoplay="false" rel="gallery" data-columns="1" data-asnavfor="#product-thumbnails" data-infinite="false">
				...
				foreach ( $attachment_ids as $attachment_id ) {
					...
					?>
						<figure itemprop="image" class="easyzoom" data-variation="<?php echo esc_attr($attr); ?>">
							<?php if ($lightbox_en) { ?><a href="<?php echo esc_attr($src[0]); ?>" itemprop="image" class="fresco" data-fresco-group="product_images" data-fresco-group-options="overflow: true" data-fresco-type="image"><?php } ?>
								<img src="<?php echo esc_attr($src_small[0]); ?>" title="<?php echo esc_attr($image_title); ?>" />
							<?php if ($lightbox_en) { ?>	</a><?php } ?>
