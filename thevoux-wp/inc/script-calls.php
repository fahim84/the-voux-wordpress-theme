...
function thb_main_styles() {	
	global $post;
	// Enqueue 
	wp_enqueue_style("thb-fa", 'https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css', null, esc_attr(Thb_Theme_Admin::$thb_theme_version));
...
function thb_register_js() {
	...
	if (!is_admin()) {
		...
		wp_register_script('thb-vendor', THB_THEME_ROOT . '/assets/js/vendor.min.js', array('jquery'), esc_attr(Thb_Theme_Admin::$thb_theme_version), TRUE);
		wp_register_script('thb-app', THB_THEME_ROOT . '/assets/js/app.min.js', array('jquery', 'thb-vendor'), esc_attr(Thb_Theme_Admin::$thb_theme_version), TRUE);
