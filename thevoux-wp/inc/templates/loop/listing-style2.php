<?php 
	...
	$image_link = wp_get_attachment_image_src($image_id,'thevoux-widget');
	
	$figure_classes[] = 'figure';
?>
<li itemscope itemtype="http://schema.org/Article" <?php post_class('post listing listing-style2'); ?> role="article">
