...
function thb_register_required_plugins() {
	...
	if (isset($data->plugins)) {
		...
		$plugins[] = array(
			...
			'source'			=> Thb_Theme_Admin::$thb_theme_directory_uri . 'inc/plugins/codecanyon-242431-visual-composer-page-builder-for-wordpress-wordpress-plugin.zip', 
			'version'				=> '5.1.1',
	...
	$plugins[] = array(
		...
		'force_activation'		=> false,
		'force_deactivation'	=> false,
		'image_url' => Thb_Theme_Admin::$thb_theme_directory_uri .'assets/img/admin/plugins/sidekick.png'
	);
	$config = array(
