  ...
  $page_metabox = array(  
    ...
    'fields'      => array(
    	...
    	array(
    	  ...
    	  'type'        => 'on_off',
    	  'desc'        => 'This will make the header transparent on this page only, and the content will come below it',
    	  'std'         => 'off'
    	),
      array(
        ...
        'desc'        => 'This changes the color of the header',
  ...
  $post_metabox = array(  
    ...
    'fields'      => array(
    	...
    	array(
    	  ...
    	  'id'          => 'post_via',
    	  'type'        => 'list-item',
    	  'desc'        => 'You can add via sources for your articles here',
    	  'settings'    => array(
    	    array(
    	      'label'       => 'Via Source URL',
    	      'id'          => 'post_source_url',
    	      'desc'        => 'Enter a URL for your via source here',
    	      'type'        => 'text',
    	    )
    	  )
    	),
    	array(
    	  ...
    	  'id'          => 'post_source',
    	  'type'        => 'list-item',
    	  'desc'        => 'You can add sources for your articles here',
    	  'settings'    => array(
    	    array(
    	      'label'       => 'Source URL',
    	      'id'          => 'post_source_url',
    	      'desc'        => 'Enter a URL for your source here',
    	      'type'        => 'text',
    	    )
    	  )
    	),
